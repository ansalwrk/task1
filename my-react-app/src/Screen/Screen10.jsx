    ...
    return (
        <>
            <div style={{ backgroundColor: "#000000ea" }}>
                ...
                <div 
                    className="flex flex-col md:flex-row mr-30 flex-wrap justify-between gap-8 px-2 md:px-10"  
                    style={{ color: "#b1b1b1", fontSize: "16px" }} 
                >
                    {/* Column 1: Logo + description + contact */}
                    <div className=" md:pl-15 col-span-2 ... flex flex-col ... w-full md:w-auto">
                        <div>
                    ...
                    {/* Column 2: Products */}
                    <div className="grid grid-cols-1 -ml-10 mb-15 md:pl-8 lg:pl-30 mt-4 md:mt-0">  
                    ...
                    {/* Column 3: Company */}
                    <div className="grid grid-cols-1 -ml-0 mb-15 md:pl-8 lg:pl-30 mt-4 md:mt-0">  
                    ...
                    {/* Column 4: Support */}
                    <div className="grid grid-cols-1 -ml-0 mb-15 md:pl-8 lg:pl-40 mt-4 md:mt-0">  
                ...
                <div 
                    className="flex flex-col md:flex-row justify-between items-center px-5. md:px-20 gap-2" 
                    style={{ color: "#b1b1b1", fontSize: "14px" }} 
                >
